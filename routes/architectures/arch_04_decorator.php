...
use App\Architectures\A04_DecoratorDomain\Phase_04\Controllers\ReservationController as A04Phase04Controller;
...
Route::prefix('arch_04/v4')->group(function () {
    Route::post('reservation', [A04Phase04Controller::class, 'store']);
    Route::get('reservation/{id}', [A04Phase04Controller::class, 'show']);
});
