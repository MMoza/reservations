...
class Arch01Phase02ReservationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_applies_volume_discount_for_7_or_more_nights()
    {
        ...
        $response = $this->postJson('/api/arch_01/v2/reservation', $payload);
    ...
    public function it_returns_reservation_with_discount_fields_on_show()
    {
        ...
        $createResponse = $this->postJson('/api/arch_01/v2/reservation', $payload);
        $reservationId = $createResponse->json('id');

        $response = $this->getJson("/api/arch_01/v2/reservation/{$reservationId}");
