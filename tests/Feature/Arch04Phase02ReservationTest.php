...
class Arch04Phase02ReservationTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function it_returns_reservation_with_discount_fields_on_show()
    {
        ...
        $createResponse = $this->postJson('/api/arch_04/v2/reservation', $payload);
        $reservationId = $createResponse->json('id');

        $response = $this->getJson("/api/arch_04/v2/reservation/{$reservationId}");
