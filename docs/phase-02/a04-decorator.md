...
- **Descuentos secuenciales vs aditivos (corregido en Phase 04):** En Phase 02, los decoradores aplicaban descuentos secuencialmente (cada uno sobre el resultado del anterior), produciendo resultados numéricos diferentes de las otras arquitecturas. Este problema se resolvió en Phase 04 introduciendo `originalBasePrice()`: ahora todos los decoradores de porcentaje calculan sobre el precio bruto original, garantizando equivalencia con A01, A02 y A03.
